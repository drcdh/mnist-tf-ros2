...
# We can only define interfaces in packages built with ament_cmake
# This comes from the alternative package mnist_ament_cmake
# Normally we'd follow best-practices and have a dedicated package for interfaces
